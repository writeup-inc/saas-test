      ...
      <section className="hero">
        <div className="shell hero-inner">
          ...
          <aside className="hero-panel" aria-label="このガイドで分かること">
            <div className="panel-head"><p className="panel-kicker">BEFORE YOU CONNECT</p><span>01—03</span></div>
            <div className="panel-row"><span>01</span><p><b>何ができるか</b><small>業務で使える場面を短く理解</small></p></div>
            <div className="panel-row"><span>02</span><p><b>何を許可するか</b><small>認証・権限・データの流れを確認</small></p></div>
            <div className="panel-row"><span>03</span><p><b>どう小さく試すか</b><small>人の承認を残した初回手順</small></p></div>
          </aside>
        </div>
      </section>

      <section className="definition-strip">
        <div className="shell definition-inner"><span>MCPとは</span><p>AIアプリケーションを、業務データやツールにつなぐためのオープンな標準です。</p><a href="https://modelcontextprotocol.io/" target="_blank" rel="noreferrer">公式仕様 ↗</a></div>
      </section>
